...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\columnwidth]{figs/heatmap Throughput (toks)_vs_Energy Efficiency (tokJ)_bfloat16.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\columnwidth]{figs/heatmap Throughput (toks)_vs_Energy Efficiency (tokJ)_fp8.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\columnwidth]{figs/efficiency_lineplot_Throughput per Instance_bfloat16.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.95\columnwidth]{figs/efficiency_boxplot_merged_active_power_avg_bfloat16_fp8.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\columnwidth]{figs/Combined_Metrics_NoBest.pdf}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\columnwidth]{figs/combined_ep_tp.pdf}
