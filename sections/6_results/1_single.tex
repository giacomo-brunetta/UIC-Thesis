...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figs/combined_performance_plots.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figs/throughput_latency_plot.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figs/trend_Latency_TTFT_Throughput_Energy.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figs/fp8_vs_bf16_improvements_subplots.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figs/throughput_by_model_with_precisions_filled.pdf}
