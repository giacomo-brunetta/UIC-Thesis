...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\columnwidth]{figs/testbeds_8B.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\columnwidth]{figs/testbeds_70.pdf}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\columnwidth]{figs/itl_ttft.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\columnwidth]{figs/power_testbeds.pdf}
